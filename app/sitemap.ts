...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return paths.map((path, index) => ({ url: absoluteUrl(path), lastModified: new Date("2026-08-07T12:00:00-04:00"), changeFrequency: index === 0 ? "daily" : "weekly", priority: index === 0 ? 1 : .7 }));
}
